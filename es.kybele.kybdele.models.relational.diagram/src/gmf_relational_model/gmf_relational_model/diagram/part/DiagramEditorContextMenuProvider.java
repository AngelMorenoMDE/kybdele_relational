...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private gmf_relational_model.gmf_relational_model.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new gmf_relational_model.gmf_relational_model.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
