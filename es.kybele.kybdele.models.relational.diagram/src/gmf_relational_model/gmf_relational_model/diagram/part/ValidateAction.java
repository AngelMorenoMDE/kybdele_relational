...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(gmf_relational_model.gmf_relational_model.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (gmf_relational_model.gmf_relational_model.diagram.part.RelationalModelDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		gmf_relational_model.gmf_relational_model.diagram.providers.RelationalModelValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			gmf_relational_model.gmf_relational_model.diagram.providers.RelationalModelMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		gmf_relational_model.gmf_relational_model.diagram.part.RelationalModelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new gmf_relational_model.gmf_relational_model.diagram.part.RelationalModelDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = gmf_relational_model.gmf_relational_model.diagram.part.RelationalModelDiagramEditorUtil
