 ...
 * @generated
 */
public abstract class RelationalModelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = gmf_relational_model.gmf_relational_model.diagram.part.RelationalModelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RelationalModelAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
