 ...
 * @generated
 */
public class RelationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * TODO JLS
	 * 
	 * Al introducir el nombre de la relacion automaticamente se
	 * convierte a mayuscula en la representacion grafica, se 
	 * almacena tal y como se introdujo.
	 * 
	 * 
	 * VERIFICADO
	 */
	protected void setLabelTextHelper(IFigure figure, String text) {
		if (figure instanceof WrappingLabel) {
			((WrappingLabel) figure).setText(text.toUpperCase());
		} else if (figure instanceof Label) {
			((Label) figure).setText(text.toUpperCase());
		} else {
			getLabelDelegate().setText(text.toUpperCase());
		}
	}
