 ...
 * @generated
 */
public class RelationalModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RelationalModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof gmf_relational_model.gmf_relational_model.diagram.navigator.RelationalModelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((gmf_relational_model.gmf_relational_model.diagram.navigator.RelationalModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new gmf_relational_model.gmf_relational_model.diagram.navigator.RelationalModelDomainNavigatorItem(
