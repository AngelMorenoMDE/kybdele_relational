...
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	...
	public EList<Attribute> getHasPK() {
		if (hasPK == null) {
			hasPK = new EObjectWithInverseResolvingEList<Attribute>(Attribute.class, this, Gmf_relational_modelPackage.RELATION__HAS_PK, Gmf_relational_modelPackage.ATTRIBUTE__IS_PK);
		}
		return hasPK;
	}
