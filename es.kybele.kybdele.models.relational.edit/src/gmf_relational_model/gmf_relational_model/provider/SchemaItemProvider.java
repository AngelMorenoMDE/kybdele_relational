...
/**
 * This is the item provider adapter for a {@link gmf_relational_model.gmf_relational_model.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Gmf_relational_modelPackage.Literals.SCHEMA__SCONTAINS_RELATIONS);
			childrenFeatures.add(Gmf_relational_modelPackage.Literals.SCHEMA__SCONTAINS_LINKS_FK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Gmf_relational_modelPackage.Literals.SCHEMA__SCONTAINS_RELATIONS,
				 Gmf_relational_modelFactory.eINSTANCE.createRelation()));

		newChildDescriptors.add
			(createChildParameter
				(Gmf_relational_modelPackage.Literals.SCHEMA__SCONTAINS_LINKS_FK,
				 Gmf_relational_modelFactory.eINSTANCE.createLinkFK()));
	}
